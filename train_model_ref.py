...
def make_model(name, use_gpu=False, max_depth=None, gamma=None, min_child_weight=None, eta=None):
...
def train_zero_shot(dataset, train_ratio, model_names, split_scheme, use_gpu, number, max_depth, min_child_weight, gamma, eta):
    # Split dataset
...
prog_inputs, prog_results = None, None
...
if __name__ == "__main__":
    ...
    #Allocate GPU
    os.environ['CUDA_VISIBLE_DEVICES'] = str(args.number % 4)
